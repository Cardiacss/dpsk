...
@section('breadcrumb')
    <p class="text-muted" style="font-size: 14px;">
        ...
        <span style="color:#2994A4;">Ahli Waris</span>
    </p>
@endsection

@section('artikel')
    <div class="container-fluid px-4"><!-- ❗Biar sejajar sama halaman Tanggungan -->
        ...
        <div class="text-end mt-4 mb-4">
            <a href="{{ url('/tanggunganpesertaadmin/' . $peserta->idanggota) }}" class="btn btn-secondary px-4 me-2">
                ← Kembali
            </a>
        </div>
