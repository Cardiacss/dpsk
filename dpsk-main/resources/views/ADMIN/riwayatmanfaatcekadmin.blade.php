      ...
      <main class="flex-1 p-6 overflow-y-auto bg-gray-100">
        <div class="bg-white rounded-lg shadow-lg p-6">
          ...
          <div class="flex gap-3 mb-6">
            <a href="/daftarpensiunadmin" class="px-4 py-2 bg-[#2994A4] text-white rounded shadow-sm">Lihat Daftar Pensiun</a>
            <a href="/pemberianmanfaatadmin" class="px-4 py-2 bg-[#2994A4] text-white rounded shadow-sm">Pemberian Manfaat</a>
          ...
          <!-- Tombol Kembali -->
          <div class="mt-6">
            <a href="/riwayatmanfaatadmin" class="inline-block px-4 py-2 bg-[#2994A4] text-white rounded">Kembali</a>
          </div>
