            ...
            <nav class="flex-1 px-4 space-y-2" x-data="{ kepesertaan: false, mitra: false, kepensiunan: false }">
                ...
                <div>
                    ...
                    <div x-show="kepesertaan" class="pl-10 mt-1 space-y-1" x-cloak>
                        ...
                        <a href="#" class="block px-3 py-1 hover:bg-cyan-800 rounded">Simulasi Kepersetaan &
                            Manfaat Pensiun</a>
                    </div>
                </div>
                ...
                <div x-data="{
                    kepensiunan: window.location.pathname.includes('pengajuanpensiunadmin') ||
                    ...
                    <button @click="kepensiunan = !kepensiunan" :class="kepensiunan ? 'bg-cyan-800' : ''"
                        class="w-full flex justify-between items-center px-3 py-2 rounded hover:bg-cyan-800">
                        <span class="flex items-center space-x-2">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="flex items-center space-x-4 mb-6">
                    <div class="flex-1">
                        ...
                        <input type="text" placeholder="Masukkan nomor peserta yang ingin dicari"
                    ...
                    <div class="flex space-x-2 pt-5">
                        ...
                        <button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Tampilkan
                            Semua</button>
                    </div>
                </div>
                    ...
                    <table class="w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="border px-4 py-2">Hidup</td>
                                <td class="border px-4 py-2 space-x-2">
                                    <a href="{{ route('detailpesertapensiun', ['idanggota' => $pensiun->id]) }}"
                                        class="px-3 py-1 bg-blue-500 text-white text-sm rounded hover:bg-blue-600">
                                        Lihat Detail
                                    </a>

                                    <a href="{{ route('pensiun.PenEdit', ['id' => $pensiun->id]) }}"
                                        class="px-3 py-1 bg-teal-600 text-white text-sm rounded hover:bg-teal-700">
                                        Ubah
                                    </a>
