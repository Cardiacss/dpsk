...
<body>
    {{-- ✅ Tambahan untuk menghindari error Undefined variable $key --}}
    @php
        $key = $key ?? '';
    @endphp
            ...
            <div class="sidebar d-flex flex-column">
                <div>
                    ...
                    <div class="nav flex-column">
                        ...
                        <!-- MITRA -->
                        <a class="nav-link d-flex justify-content-between align-items-center {{ $key == 'mitra' ? 'active' : '' }}"
                        ...
                        <!-- KEPERSERTAAN -->
                        <a class="nav-link d-flex justify-content-between align-items-center {{ $key == 'kepersertaan' ? 'active' : '' }}"
                            data-toggle="collapse" href="#kepersertaanMenu" role="button" aria-expanded="false"
                            aria-controls="kepersertaanMenu">
                            <span><i class="bi bi-person-lines-fill"></i> Kepesertaan</span>
                            <i class="bi bi-caret-down-fill"></i>
                        </a>
                        ...
                        <!-- KEPENSIUNAN -->
                        <a class="nav-link d-flex justify-content-between align-items-center {{ $key == 'kepensiunan' ? 'active' : '' }}"
                        ...
                        <div class="collapse" id="kepensiunanMenu">
                            <div class="submenu">
                                ...
                                <a class="nav-link" href="/manfaat">
                                    <i class="bi bi-gift"></i>Pemberian Manfaat
                                </a>
                                <a class="nav-link" href="/riwayatmanfaat">
                                    <i class="bi bi-clock-history"></i> Riwayat Manfaat
                                </a>
                                <a class="nav-link" href="/terminasipensiun">
                                    <i class="bi bi-list-check"></i> Daftar Terminasi Pensiun
                                </a>
                            </div>
                        </div>

                        <!-- MASTER -->
                        <a class="nav-link d-flex justify-content-between align-items-center {{ $key == 'master' ? 'active' : '' }}"
