...
@section('breadcrumb')
    <p class="text-muted" style="font-size: 14px;">
        ...
        <a href="/riwayatiuranadmin" style="text-decoration:none; color:#555;">
            Riwayat Iuran
        </a> /

        <a href="{{ route('admin.detailmitra', $mitra->idmitra) }}" style="text-decoration:none; color:#2994A4;">
            Daftar Peserta Riwayat Iuran
        </a>
