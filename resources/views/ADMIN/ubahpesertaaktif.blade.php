...
@section('breadcrumb')
    <p class="text-muted" style="font-size: 14px;">
        ...
        <a href="/lihatpensiun" style="text-decoration:none; color:#555;">
            Lihat Pensiun
        </a> /

        @if (isset($pensiun))
            <a href="{{ url('/pensiun/edit/' . $pensiun->idanggota) }}" style="text-decoration:none; color:#2994A4;">
                Ubah Peserta Aktif
            </a>
        @else
            <span style="color:#999;">Ubah Peserta Aktif</span>
        @endif
    </p>
@endsection
        ...
        <div style="width: 100%; max-width: 700px;">
            ...
            <form method="POST" action="{{ route('admin.pensiun.update', $pensiun->idanggota) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nopensiun" class="form-control" value="{{ $pensiun->nopensiun }}" readonly>
                </div>
                <div class="form-group mb-3">
                    <label>Nama Peserta</label>
                    <input type="text" name="nama" class="form-control" value="{{ $peserta->nama }}" readonly>
                </div>

                <div class="form-group mb-3">
                    <label>Tanggal Mohon</label>
                    <input type="date" name="tglmohon" class="form-control"
                        value="{{ $pensiun->tglmohon ? $pensiun->tglmohon->format('Y-m-d') : '' }}">
                </div>

                <div class="form-group mb-3">
                    <label>Terhitung Mulai Tanggal</label>
                    <input type="date" name="tmtpensiun" class="form-control"
                        value="{{ $pensiun->tmtpensiun ? $pensiun->tmtpensiun->format('Y-m-d') : '' }}">
                </div>

                <div class="form-group mb-3">
                    <label>No Surat Berhenti</label>
                    <input type="text" name="nosuratberhenti" class="form-control"
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="pensiun" class="form-control">
                        <option value="Pensiun" {{ $pensiun->pensiun == 'Pensiun' ? 'selected' : '' }}>Pensiun</option>
                        <option value="Selesai" {{ $pensiun->pensiun == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                    </select>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="pertama_terima" class="form-control"
                            value="{{ $pensiun->pertama_terima }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Terakhir Terima Pada</label>
                        <input type="text" name="terakhir_terima" class="form-control"
                            value="{{ $pensiun->terakhir_terima }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="mpakhir" class="form-control" value="{{ $pensiun->mpakhir }}">
                    </div>
                    <div class="col-md-6 mb-3">
