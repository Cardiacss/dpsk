        ...
        <div style="width: 100%; max-width: 700px;">
            ...
            <form method="POST" action="{{ route('admin.pensiun.update', $pensiun->idanggota) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nosuratberhenti" class="form-control" value="{{ $pensiun->nosuratberhenti }}">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="mpakhir" class="form-control"
                            value="{{ $pensiun->mpakhir }}">
                    </div>
                    <div class="col-md-6 mb-3">
