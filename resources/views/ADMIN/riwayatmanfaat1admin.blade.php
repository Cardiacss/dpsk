...
>
  ...
  <div x-show="mitra" class="pl-10 mt-1 space-y-1" x-cloak>
   ...
   <!-- Kepensiunan Dropdown -->
    ...
    <nav class="text-sm mb-6 text-gray-600">
      Kepensiunan &gt; <a href="/riwayatmanfaatadmin" class="text-blue-600">Riwayat Manfaat</a>
    </nav>

    <!-- Tombol Aksi -->
    <div class="flex space-x-3 mb-6">
      <a href="/daftarpensiunadmin" class="px-4 py-2 bg-[#2994A4] text-white rounded hover:bg-cyan-700">Lihat Daftar Pensiun</a>
      <a href="/pemberianmanfaatadmin" class="px-4 py-2 bg-[#2994A4] text-white rounded hover:bg-cyan-700">Pemberian Manfaat</a>
  ...
  <a href="/riwayatmanfaatcekadmin"
    ...
    <!-- Tombol Kembali -->
    <div class="mt-6">
      <a href="/riwayatmanfaatadmin" class="px-4 py-2 bg-gray-400 text-white rounded hover:bg-gray-500">Kembali</a>
    </div>
  </main>
</body>
</html>
