...
@section('breadcrumb')
    <p class="text-muted" style="font-size: 14px;">
        ...
        <a href="/iuranpesertaadmin" style="text-decoration:none; color:#2994A4;">Iuran Peserta</a>
    </p>
@endsection
...
@section('artikel')
    ...
    <form action="{{ route('admin.iuranpeserta') }}" method="GET" class="mb-3 d-flex align-items-center">
        <input type="text"
               ...
               placeholder="Silahkan Masukan Kode/Nama Mitra">
                ...
                @forelse ($mitras as $m)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ url('/bukamitraadmin/' . $m->idunit) }}"
