...
<p class="text-muted" style="font-size: 14px;">
    ...
    <a href="/peraturan" style="text-decoration:none; color:#2994A4;">Peraturan</a>
</p>
@endsection
...
<div class="container">
    ...
    @if ($data1->isNotEmpty())
        ...
        @endforeach
    @else
        @include('ADMIN.partials.peraturan_form', ['item' => null, 'skepentingan' => 'Penawaran Pensiun'])
    @endif
    <hr>
    ...
    @if ($data2->isNotEmpty())
        ...
        @endforeach
    @else
        @include('ADMIN.partials.peraturan_form', ['item' => null, 'skepentingan' => 'SKNormalMengingat1'])
    @endif
    <hr>
    ...
    @if ($data3->isNotEmpty())
        ...
        @endforeach
    @else
        @include('ADMIN.partials.peraturan_form', ['item' => null, 'skepentingan' => 'SKNormalMengingat2'])
    @endif
