...
@section('breadcrumb')
    <p class="text-muted" style="font-size: 14px;">
        ...
        <a href="{{ route('admin.pilihpensiun', ['idmitra' => $mitra->idmitra]) }}" style="text-decoration:none; color:#2994A4;">
...
<div class="card">
    <div class="card-body">
        ...
        {{-- Form Pencarian --}}
        <form action="{{ route('admin.pilihpensiun', ['idmitra' => $mitra->idmitra]) }}" method="GET" class="form-inline mb-3">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped text-center" 
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-3">Tidak ada peserta pensiun untuk mitra ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
