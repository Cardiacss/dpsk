...
@section('breadcrumb')
    <p class="text-muted" style="font-size: 14px;">
        ...
        <a href="{{ url('/tanggunganpesertaadmin/' . $peserta->idanggota) }}" style="text-decoration:none; color:#2994A4;">
            Tanggungan Peserta 
        </a>
    </p>
@endsection
                ...
                <tbody>
                    @forelse ($keluarga as $k)
                        <tr>
                            <td>{{ $k->nm_keluarga }}</td>
                            <td>{{ $k->tempatlahir }} /
                                {{ $k->tgllahir ? \Carbon\Carbon::parse($k->tgllahir)->format('Y-m-d') : '-' }}</td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="/editanggotaahliwarispesertaadmin/{{ $k->idkeluarga }}"
                                        ...
                                        style="background-color:#FFC107; color:white; margin-right:10px;">
