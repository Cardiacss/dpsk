    ...
    <div class="card-body">
        ...
        <div class="riwayatpensiunmitra-tabs mb-4">
            <ul class="nav nav-pills justify-content-center" id="mitrapensiunTab">
                <li class="nav-item">
                    <a href="/daftarpensiun" class="nav-link">Daftar Pensiun</a>
                </li>
                <li class="nav-item">
                ...
                <tbody>
                    @forelse($manfaat as $index => $m)
                        <tr>
                            ...
                            <td>{{ $m->keterangan }}</td>
<td>
    <form action="{{ route('hapusmanfaat', $m->idmanfaatpensiun) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
        @csrf
        @method('DELETE')
            ...
            <div class="modal-body text-center p-5">
                ...
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-danger px-4 mx-2"
                        onclick="alert('Data berhasil dihapus')" data-dismiss="modal">
                        Hapus
                    </button>
                </div>
            </div>
