      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 gap-4 bg-white p-4 rounded shadow mb-6">
          <div>
            ...
            <input type="text" class="w-full border rounded px-2 py-1 bg-gray-100" value="{{ $peserta->nopeserta }}"
              readonly>
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" class="w-full border rounded px-2 py-1 bg-gray-100" value="{{ $peserta->nama }}"
              readonly>
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" class="w-full border rounded px-2 py-1 bg-gray-100" value="Aktif" readonly>
          </div>
        </div>

        <h2 class="font-semibold mt-8 mb-2">Daftar Anggota Keluarga</h2>
          ...
          <table class="w-full text-sm">
            <thead class="bg-teal-600 text-white">
              <tr>
                ...
                <th class="py-2 px-4 text-left">Status Hidup</th>
              </tr>
            </thead>
            <tbody>
              ...
              @empty
                <tr>
                  <td colspan="5" class="text-center py-4 text-gray-500">
                    Tidak ada anggota keluarga untuk peserta ini.
                  </td>
                </tr>
              @endforelse
            </tbody>
